...
#define X(name, object)                                                                            \
    RetType name(object<NodeTrait> *, Args...) {                                                   \
 ...
 */
template <typename NodeTrait> class DynamicVisitor KIWI_DV_INHERIT {
  public:
    // typedef Expression<NodeTrait> Node;
    // typedef typename Call<NodeTrait> Call;
    ...
    */
    ...
    VTABLEV(void traverse(Expression<NodeTrait> x) { x->visit(this); })
