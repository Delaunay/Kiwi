...
template <typename> class expected_common;

template <typename T> class expected_traits {
...
template <typename T> class expected_traits<T &> {
  friend class expected_common<T &>;
...
template <typename T> class expected_traits<const T &> {
...
template <typename T> class expected_common {
...
template <typename T> class expected : public expected_common<T> {
  friend class expected_common<T>;
...
public:
  template <class... AA>
  expected(AA &&... arguments) : common(std::forward<AA>(arguments)...) {}
...
template <typename T> class expected<T &> : public expected_common<T &> {
  friend class expected_common<T &>;
  typedef expected_common<T &> common;
