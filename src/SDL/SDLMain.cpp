...
int main(){
    ...
    while(running && SDL_WaitEvent(&event)){
        ...
        log_debug(kiwi::to_string(event));
    ...
    SDL_Quit();
#else
    kiwi::SDLWindow w1 = kiwi::WindowManager::new_window("A, B, C", 500, 500, SDL_WINDOW_SHOWN | SDL_WINDOW_RESIZABLE);

    kiwi::SDLWindow w2 = kiwi::WindowManager::new_window("A, B, C", 500, 500, SDL_WINDOW_SHOWN | SDL_WINDOW_RESIZABLE);
